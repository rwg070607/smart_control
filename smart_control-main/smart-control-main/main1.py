...
# 아이콘에 사용할 이미지 생성 함수
def create_image():
    image = Image.open(r"C:\Users\삼성\Downloads\smart_control-main\smart_control-main\smart_control-main\smart-control-main\imgs\icon.png")
    return image
...
def background_task():
    ...
    while cap.isOpened():
        ...
        if safety_mode:
            ...
            cv2.putText(image, "Safe Mode Activated", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
